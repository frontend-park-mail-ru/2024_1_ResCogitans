...
class LoginForm {
    ...
    render() {
        ...
        new Input(loginForm, {type: 'email', placeholder: 'Электронная почта', _class:'form-input'}).render();
        new Input(loginForm, {type: 'password', placeholder: 'Пароль', _class:'form-input'}).render();
        new Button(loginForm, {id: "login-button", label: 'Войти', type: 'submit', _class:'form-input'}).render();
