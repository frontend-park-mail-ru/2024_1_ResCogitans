...
;// CONCATENATED MODULE: ./src/components/Header/Link/index.js
...
class RegistrationForm {
  ...
  render() {
    ...
    new components_Input_Input(registrationForm, { type: 'email', placeholder: 'Электронная почта', className: 'form-input' }).render();
    new components_Input_Input(registrationForm, { type: 'password', placeholder: 'Пароль', className: 'form-input' }).render();
    new components_Input_Input(registrationForm, { type: 'password', placeholder: 'Повторите пароль', className: 'form-input' }).render();
    new components_Button_Button(registrationForm, { id: 'register-button', label: 'Зарегистрироваться' }).render();
  }
}

/* harmony default export */ const Header_RegistrationForm_RegistrationForm = (RegistrationForm);

;// CONCATENATED MODULE: ./src/components/Header/RegistrationForm/index.js
...
class LoginForm {
  ...
  render() {
    ...
    new components_Input_Input(loginForm, { type: 'email', placeholder: 'Электронная почта', className: 'form-input' }).render();
    new components_Input_Input(loginForm, { type: 'password', placeholder: 'Пароль', className: 'form-input' }).render();
...
;// CONCATENATED MODULE: ./src/components/Header/LoginForm/index.js
...
;// CONCATENATED MODULE: ./src/components/Placelist/Place/index.js
...
class Placelist {
  ...
  render() {
    ...
    DATA.forEach((data) => new Placelist_Place_Place(placelist, data.data).render());
  }
}
...
new pages_Main_Main(root).render();
