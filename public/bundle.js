...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"login-form-div\" style=\"display: "
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"registration-form-div\" style=\"display: "
    + container.escapeExpression(container.lambda((depth0 != null ? lookupProperty(depth0,"display") : depth0), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"card\">\n    <img src=\""
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"rating") || (depth0 != null ? lookupProperty(depth0,"rating") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"rating","hash":{},"data":data,"loc":{"start":{"line":5,"column":32},"end":{"line":5,"column":42}}}) : helper)))
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h1>Все интересные места:</h1>\n    <div id=\"list-places\">\n                   \n    </div>";
},"useData":true});
...
var _handlebarsRuntime = __webpack_require__(642);
...
var Logo_default = /*#__PURE__*/__webpack_require__.n(Logo_Logo);
;// CONCATENATED MODULE: ./src/components/Header/Logo/Logo.js
...
/* harmony default export */ const Header_Logo_Logo = (Logo);

// EXTERNAL MODULE: ./src/components/Header/Link/Link.hbs
var Link_Link = __webpack_require__(901);
var Link_default = /*#__PURE__*/__webpack_require__.n(Link_Link);
;// CONCATENATED MODULE: ./src/components/Header/Link/Link.js
...
// EXTERNAL MODULE: ./src/components/Header/LoginForm/LoginForm.hbs
var LoginForm_LoginForm = __webpack_require__(435);
...
// EXTERNAL MODULE: ./src/components/Header/RegistrationForm/RegistrationForm.hbs
var RegistrationForm_RegistrationForm = __webpack_require__(715);
var RegistrationForm_default = /*#__PURE__*/__webpack_require__.n(RegistrationForm_RegistrationForm);
;// CONCATENATED MODULE: ./src/components/Header/RegistrationForm/RegistrationForm.js
...
class RegistrationForm {
  ...
  getHTML() {
    return RegistrationForm_default()(this.display);
  }

  render() {
    this.parent.insertAdjacentHTML('beforeend', this.getHTML());
    const registrationForm = document.getElementById('registration-form');
    new components_Input_Input(registrationForm, { field: 'username-register', type: 'text', placeholder: 'Логин', className: 'form-input' }).render();
    new components_Input_Input(registrationForm, { field: 'username-password', type: 'password', placeholder: 'Пароль', className: 'form-input' }).render();
    new components_Button_Button(registrationForm, { id: 'register-button', label: 'Зарегистрироваться', type: 'submit' }).render();
   ...
   registrationForm.addEventListener('submit', (e) => {
      ...
      .then(data => {
           if (data.Code != null) {
            new Header_Link_Link(registrationForm, {className : 'err-lin1k', label: data.error}).render()
          } else {
            ...
            new pages_Main_Main(document.getElementById('root')).render();
          }
      })
      .catch((error) => {
...
/* harmony default export */ const Header_RegistrationForm_RegistrationForm = (RegistrationForm);

;// CONCATENATED MODULE: ./src/components/Header/LoginForm/LoginForm.js
...
class LoginForm {
  ...
  getHTML() {
    return LoginForm_default()(this.display);
  }

  render() {
    this.parent.insertAdjacentHTML('beforeend', this.getHTML());
    const loginForm = document.getElementById('login-form');
    new components_Input_Input(loginForm, { field: 'username-login', type: 'text', placeholder: 'Электронная почта', className: 'form-input' }).render();
    new components_Input_Input(loginForm, { field: 'username-password', type: 'password', placeholder: 'Пароль', className: 'form-input' }).render();
    new components_Button_Button(loginForm, {
      id: 'login-button', label: 'Войти', type: 'submit', className: 'form-input',
    }).render();
    new components_Button_Button(loginForm, { id: 'register-button', label: 'Регистрация' }).render();
    ...
    loginForm.addEventListener('submit', (e) => {
      ...
      .then(data => {
        if (data.Code != null) {
          new Header_Link_Link(loginForm, {className : 'err-link', label: data.error}).render()
    ...
    registerButton.addEventListener('click', (e) => {
      ...
      switch (state) {
        case 0:
          ...
          new Header_RegistrationForm_RegistrationForm(content, { display: 'flex' }).render();
          state = 2;
...
/* harmony default export */ const Header_LoginForm_LoginForm = (LoginForm);
...
class Header {
  ...
  renderLinkBlock(parent, labels) {
    labels.forEach((label) => new Header_Link_Link(parent, { label }).render());
  }
  ...
  render() {
    ...
    const currencyButton = new components_Button_Button(buttonGroup, { id: 'button-region', img: '../../static/globe.svg' });
    ...
    if (username != "") {
      const profile = new Header_Link_Link(profileBlock, {className: 'user-link', label : username}).render()
      const logout = new components_Button_Button(profileBlock, {id: 'logout', className: 'login-group-button', label: 'Выйти'}).render();
      ...
      const loginButton = new components_Button_Button(profileBlock, { id: 'button-login', label: 'Войти' });
      loginButton.render();
      let state = 0;
      document.getElementById('button-login').addEventListener('click', (e) => {
        const body = document.getElementById('root');
        const form = new Header_LoginForm_LoginForm(body, { display: 'flex' });
        switch (state) {
          case 0:
            form.render();
            state = 1;
...
;// CONCATENATED MODULE: ./src/components/MainSearch/MainSearch.js
...
class MainSearch {
  ...
  render() {
    ...
    new Header_Link_Link(linkArea, { class: 'search-link', src: '../static/restaurant.svg', label: 'Рестораны' }).render();
    new Header_Link_Link(linkArea, { class: 'search-link', src: '../static/hotel.svg', label: 'Отели' }).render();
    new Header_Link_Link(linkArea, { class: 'search-link', src: '../static/attraction.svg', label: 'Развлечения' }).render();

    const searchbarArea = document.getElementById('form-search');
    new components_Input_Input(searchbarArea, {
      id: 'searchbar',
    ...
    new components_Button_Button(searchbarDiv, { type: 'submit', label: 'Поиск' }).render();
  }
}

/* harmony default export */ const components_MainSearch_MainSearch = (MainSearch);

// EXTERNAL MODULE: ./src/components/Placelist/Place/Place.hbs
var Place_Place = __webpack_require__(791);
var Place_default = /*#__PURE__*/__webpack_require__.n(Place_Place);
;// CONCATENATED MODULE: ./src/components/Placelist/Place/Place.js
...
/* harmony default export */ const Placelist_Place_Place = (Place);

// EXTERNAL MODULE: ./src/components/Placelist/Placelist.hbs
var Placelist_Placelist = __webpack_require__(475);
var Placelist_default = /*#__PURE__*/__webpack_require__.n(Placelist_Placelist);
...
;// CONCATENATED MODULE: ./src/components/Placelist/Placelist.js
...
/* harmony default export */ const components_Placelist_Placelist = (Placelist);

// EXTERNAL MODULE: ./src/pages/Main/Main.hbs
var Main_Main = __webpack_require__(279);
var Main_default = /*#__PURE__*/__webpack_require__.n(Main_Main);
...
class Main {
  ...
  render() {
    ...
    new components_Header_Header(content).render();
    new components_MainSearch_MainSearch(search).render();
    new components_Placelist_Placelist(search).render();
  }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new pages_Main_Main(root, sessionCookie).render();
});
