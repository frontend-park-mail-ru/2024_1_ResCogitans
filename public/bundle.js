...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id=\"main-search\">\n    <h1>Куда путь держим?</h1>\n    <div id=\"search-block\">\n        <div id=\"search-links\">\n                \n        </div>\n        <form id=\"form-search\" method=\"get\">\n                       \n        </form>\n    </div>    \n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id=\"login-form-div\" style=\"display: flex\">\n    <div id=\"logo-group\">\n\n    </div>  \n    <h2>Войти</h2>\n    <form id=\"login-form\" method=\"post\">\n\n    </form>\n</div>";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id=\"header\">\n</div>\n<div id=\"notfound\">\n    <p>404 — страница не найдена</p>\n    <h2>Где Тридевятое Царство — не покажут даже наши алгоритмы</h3>\n    <h2>Но мы точно можем организовать Вам незабываемую поездку!</h3>\n</div>";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id=\"registration-form-div\" style=\"display: flex\">\n    <div id=\"logo-group\">\n\n    </div>  \n    <h2>Создать аккаунт</h2>\n    <form id=\"registration-form\" method=\"post\">\n\n    </form>\n</div>";
},"useData":true});
...
class LoginForm {
  ...
  */
  displayErrorOrRedirect(response, error) {
    if (response.Code == null) {
      ...
      new Header_Link_Link(loginForm, { id: 'form-error', className: 'err-link', label: response.error }).render();
    } else {
      const loginForm = document.getElementById('login-form');
      document.getElementById('form-error')?.remove();
      new Header_Link_Link(loginForm, { id: 'form-error', className: 'err-link', label: error }).render();
    }
  }
  ...
  */
  render() {
    ...
    const logoGroup = document.getElementById('logo-group');
    new Header_Logo_Logo(logoGroup).render();
    const loginForm = document.getElementById('login-form');
    new components_Input_Input(loginForm, {
    ...
    registerButton.addEventListener('click', () => {
      router.go(router_urls.signup);
    });
  }
}

/* harmony default export */ const LoginPage_LoginForm_LoginForm = (LoginForm);

;// CONCATENATED MODULE: ./src/pages/LoginPage/LoginPage.js
...
class LoginPage {
  ...
  */
  render() {
    ...
    new LoginPage_LoginForm_LoginForm(this.parent).render();
  }
}
...
class MainSearch {
  ...
  */
  asHTML() {
    return MainSearch_default()(this);
  }
  ...
  */
  render() {
    ...
    new Header_Link_Link(linkArea, { className: 'search-link', src: '../static/restaurant.svg', label: 'Рестораны' }).render();
    new Header_Link_Link(linkArea, { className: 'search-link', src: '../static/hotel.svg', label: 'Отели' }).render();
    new Header_Link_Link(linkArea, { className: 'search-link', src: '../static/attraction.svg', label: 'Развлечения' }).render();
...
// EXTERNAL MODULE: ./src/pages/PlacesPage/Placelist/Place/Place.hbs
var Place_Place = __webpack_require__(621);
var Place_default = /*#__PURE__*/__webpack_require__.n(Place_Place);
;// CONCATENATED MODULE: ./src/pages/PlacesPage/Placelist/Place/Place.js
...
// EXTERNAL MODULE: ./src/pages/PlacesPage/Placelist/Placelist.hbs
var Placelist_Placelist = __webpack_require__(373);
var Placelist_default = /*#__PURE__*/__webpack_require__.n(Placelist_Placelist);
;// CONCATENATED MODULE: ./src/api/sights.js
/**
...
/* harmony default export */ const PlacesPage_Placelist_Placelist = (Placelist);

// EXTERNAL MODULE: ./src/pages/PlacesPage/PlacesPage.hbs
var PlacesPage_PlacesPage = __webpack_require__(823);
var PlacesPage_default = /*#__PURE__*/__webpack_require__.n(PlacesPage_PlacesPage);
;// CONCATENATED MODULE: ./src/pages/PlacesPage/PlacesPage.js
...
class PlacesPage {
  ...
  */
  asHTML() {
    return PlacesPage_default()(this);
  }
  ...
  */
  render() {
    ...
    new components_Header_Header(header).render();
    new components_MainSearch_MainSearch(mainsearch).render();
    new PlacesPage_Placelist_Placelist(mainsearch).render();
  }
}

/* harmony default export */ const pages_PlacesPage_PlacesPage = (PlacesPage);

// EXTERNAL MODULE: ./src/pages/SignupPage/SignupPage.hbs
var SignupPage_SignupPage = __webpack_require__(787);
var SignupPage_default = /*#__PURE__*/__webpack_require__.n(SignupPage_SignupPage);
// EXTERNAL MODULE: ./src/pages/SignupPage/SignupForm/SignupForm.hbs
var SignupForm_SignupForm = __webpack_require__(679);
var SignupForm_default = /*#__PURE__*/__webpack_require__.n(SignupForm_SignupForm);
;// CONCATENATED MODULE: ./src/pages/SignupPage/SignupForm/SignupForm.js
...
class SignupForm {
  ...
  */
  asHTML() {
    return SignupForm_default()(this.display);
  }
  ...
  */
  displayErrorOrRedirect(response) {
    if (response.Code == null) {
      ...
      document.getElementById('form-error')?.remove();
      new Header_Link_Link(registrationForm, { id: 'form-error', className: 'err-link', label: response.error }).render();
    }
  }
  ...
  */
  render() {
    ...
    const registrationForm = document.getElementById('registration-form');
    new components_Input_Input(registrationForm, {
      field: 'username-register', type: 'text', placeholder: 'Логин', className: 'form-input',
    }).render();
    new components_Input_Input(registrationForm, {
      field: 'username-password', type: 'password', placeholder: 'Пароль', className: 'form-input',
    }).render();
    new components_Button_Button(registrationForm, { id: 'login-button', label: 'Зарегистрироваться', type: 'submit' }).render();
...
/* harmony default export */ const SignupPage_SignupForm_SignupForm = (SignupForm);

;// CONCATENATED MODULE: ./src/pages/SignupPage/SignupPage.js
...
class SignupPage {
  ...
  */
  render() {
    document.body.style.backgroundImage = 'url(\'../../static/bglogin.webp\')';
    new SignupPage_SignupForm_SignupForm(this.parent).render();
  }
}
